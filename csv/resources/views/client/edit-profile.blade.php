                                ...
                                <form action="/editProfile" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            @if($student->studentID == null)
                                                <input id="student_id" name="studentID" placeholder="Mã số sinh viên" class="form-control here"
                                                   required="required" type="text">
                                            @else
                                                <input id="student_id" name="studentID" value="{{$student->studentID}}" class="form-control here"
                                                       required="required" type="text">
                                            @endif
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            @if($student->name == null)
                                                <input id="fullName" name="name" placeholder="Họ và tên đầy đủ" class="form-control here"
                                                   required="required" type="text">
                                            @else
                                                <input id="fullName" name="name" value="{{$student->name}}" class="form-control here"
                                                       required="required" type="text">
                                             @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="file" accept="image/jpeg" class="form-control-file" id="avatar-select" name="avatar">
                                            </div>
                                            {{--@if($student->avatar == null)--}}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            ...
                                            @else
                                                <input id="email" name="email" value="{{$student->email}}" class="form-control here"
                                                       required="required" type="email">
                                            @endif
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            @if($student->phone == null)
                                                <input id="phone" name="phone" placeholder="Số điện thoại" class="form-control here"
                                                   required="required" type="text">
                                            @else
                                                <input id="phone" name="phone" value="{{$student->phone}}" class="form-control here"
                                                       required="required" type="text">
                                            @endif
                                        </div>
                                    </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            $('[name="province"]').change(function () {
                ...
                getDistrict(selectedProvince);s
            })
